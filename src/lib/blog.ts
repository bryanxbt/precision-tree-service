    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "At QB Tree Services we give free written estimates for most residential jobs from Greenwood to Kokomo — so you can compare apples to apples before anyone starts cutting.",
        ],
      },
      {
        heading: "Red flags",
